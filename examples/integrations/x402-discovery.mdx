---
title: 'x402 Discovery Query'
description: 'Discover and query x402-enabled services from your Swarms agents.'
icon: 'satellite-dish'
---
...
- [X402 Payment Integration](/examples/integrations/x402-payment) - Learn how to monetize your agents with X402
- [Agent Tools Reference](/examples/overviews/tools-overview) - Understand how to create and use tools with agents
